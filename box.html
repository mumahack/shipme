        ...
        <div class="inputbox well well-lg">
            <form class="form-horizontal" method="post" action="suche.php">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" name="email" id="inputEmail3" placeholder="Start" value="Hufeisenstraße 10, München">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label">Bis</label>
                    <div class="col-sm-10">
                        <input class="form-control" name="pass" id="inputPassword3" placeholder="Ziel" value="Heimpertstrasse 6d, München">
                    </div>
                </div>
                <div class="form-group">
